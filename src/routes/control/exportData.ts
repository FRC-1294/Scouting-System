...
export let get: RequestHandler = async function () {
    ...
    try {
        ...
        res.forEach(async (t: App.AggregatedTeamData) => {
            let notes = await getTeamNotes(t._id)
            let string = `${t._id},${t.averageCargoAuto},${t.averageCargoTele},${t.averageMissedCargo},${t.climb.low.percent},${t.climb.mid.percent},${t.climb.high.percent},${t.climb.traverse.percent},${t.defensePercent},${t.hub.lower.percent},${t.hub.upper.percent},${t.reliablePercent},${t.stuckPercent},${notes.notes}\r\n`
            console.log(string)
